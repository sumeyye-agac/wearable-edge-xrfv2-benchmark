...
- `repro_manifest.json`: optional end-to-end reproduction ledger generated by `scripts/reproduce_full_run.py`
...
- `runs/repro_full_latest.json`: latest full-pipeline reproduction manifest
